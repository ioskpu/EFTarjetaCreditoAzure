...
//     private toastr: ToastrService, private _tarjetaService: TarjetaService) {   
...
//         this.toastr.success('La tarjeta fue agregada correctamente!', 'Tarjeta agregada!');
//         this.obtenerTarjetas();
//         this.form.reset();      
//       }, error => {
//         this.toastr.error('La tarjeta no fue agregada!', 'Error!');
//         console.log(error);
//       })
...
//           this.obtenerTarjetas();
//         }, error => {
//           this.toastr.error('La tarjeta no fue actualizada!', 'Error!');
//           console.log(error);
//         })
//       }
//     }
